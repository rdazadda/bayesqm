...
the verdict says so. The grizzly bear panel, the package’s second
shipped dataset, resolves the other way, the rule selects two viewpoints
there, with one factor holding both sides of the reintroduction
question. The classical analysis of the obesity panel reports three
factors, and the validation article shows how the two accounts relate,
factor by factor.

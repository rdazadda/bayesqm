...
agree. The separation delta is computed by default as the Bayesian
reliability-adjusted critical difference (`critical_delta()`);
...
The divergence summary is stored on `fit$qdc`, and `critical_delta()`
